...
{
	if( APlayerController *PC = UGameplayStatics::GetPlayerController( WorldContextObject, 0 ) ) // multiplayer: UWorld::GetFirstPlayerController() may be better than passing in 0
	{
